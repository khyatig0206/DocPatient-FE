  ...
  return (
    ...
    <div className="container mx-auto p-4">
      ...
      <form onSubmit={handleSearch} className='flex items-center space-x-6 mb-4'>
        ...
        <button
          type="submit"
          className="bg-mycolor shadow-md text-white md:text-base sm:text-sm px-4 py-2 rounded hover:bg-buttoncolor2 transition-transform transform hover:scale-95 z-20">
          Search
        </button>
      </form>
