...
const BlogCard = () => {
  ...
  return (
    <div className="grid bg-buttoncolor2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
      {posts.map(post => (
        <div 
        key={post.id} 
        className="max-w-xs mx-auto bg-white shadow-md rounded-md overflow-hidden transition-transform transform cursor-pointer"
